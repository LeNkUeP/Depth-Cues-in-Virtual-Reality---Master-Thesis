...
public class DepthCueToggler : MonoBehaviour
{
    ...
    public float nearSoftDistance = 2f;
    [Range(1, 32)]
    ...
    public Vector3 convergenceCameraScale = new Vector3(2f, 2f, 2f);
    ...
    private void Update()
    {
        ...
        // scale all "equal" objects relative to distance until detoggled, also needed for linear perspective (other attempt)
    ...
    public virtual void ToggleOcclusion()
    {
    ...
    public virtual void ToggleDisparity()
    {
    ...
    public virtual void ToggleConvergence()
    {
    ...
    public virtual void ToggleAccommodation()
    {
    ...
    public virtual void ToggleImageBlur()
    {
    ...
    public virtual void ToggleLinearPerspective()
    {
    ...
    public virtual void ToggleTextureGradient()
    {
    ...
    public virtual void ToggleRelativeSize()
    {
    ...
    public virtual void ToggleKnownSize()
    {
    ...
    public virtual void ToggleHeightInFieldOfView()
    {
    ...
    {
        // angle, visualheight = 0 -> eye level
    ...
    public virtual void ToggleAtmosphericPerspective()
    {
    ...
    public virtual void ToggleShapeFromShading()
    {
    ...
    public virtual void ToggleShadowCast()
    {
    ...
    public virtual void ToggleMotionParallax()
    {
    ...
    public virtual void ToggleAccretion()
    {
